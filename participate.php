...
<body>
    <div class="container">
        ...
        if (isset($_POST["submit"])) 
        {
            ...
            $sql = "SELECT * FROM participate_info WHERE email = '$email'";
            ...
            {
                require_once "database.php";
                $sql = "INSERT INTO participate_info (fname, email, phone, age, address, comment) VALUES (?, ?, ?, ?, ?, ?)";
                $stmt = mysqli_stmt_init($conn);
                $prepareStmt = mysqli_stmt_prepare($stmt,$sql);
                if($prepareStmt) 
                {
                    mysqli_stmt_bind_param($stmt,"ssiiss",$fname, $email, $phone, $age, $address, $comment);
        ...
        ?>
                    ...
                    <form id="adoptForm" action="participate.php" method="post">
                ...
                <!-- One "tab" for each step in the form: -->
                    ...
                    <br>
                    <p><input type="submit" class="btn btn-primary" value="Participate" name="submit"><p>
                </form>
    </div>
</body> 
</html>
